...
public class GoogleFitManager implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ActivityEventListener {
    ...
    public WritableArray getAggregatedStepsByDays(long startTime, long endTime) {
        WritableArray dataItems = QueryAggregator.getAggregatedDataByDays(mApiClient, startTime, endTime, DataType.TYPE_STEP_COUNT_DELTA, DataType.AGGREGATE_STEP_COUNT_DELTA, "int");
        return dataItems;
    }
    
    public WritableArray getAggregatedCaloriesByDays(long startTime, long endTime) {
        WritableArray dataItems = QueryAggregator.getAggregatedDataByDays(mApiClient, startTime, endTime, DataType.TYPE_CALORIES_EXPENDED, DataType.AGGREGATE_CALORIES_EXPENDED, "float");
        return dataItems;
    }

    public WritableArray getAggregatedDistanceByDays(long startTime, long endTime) {
        WritableArray dataItems = QueryAggregator.getAggregatedDataByDays(mApiClient, startTime, endTime, DataType.TYPE_DISTANCE_DELTA, DataType.AGGREGATE_DISTANCE_DELTA, "float");
        return dataItems;
    }

    public WritableArray getAggregatedActiveTimeByDays(long startTime, long endTime) {
        WritableArray dataItems = QueryAggregator.getAggregatedDataByDays(mApiClient, startTime, endTime, DataType.TYPE_ACTIVITY_SEGMENT, DataType.AGGREGATE_ACTIVITY_SUMMARY, "int");
        return dataItems;
    }
