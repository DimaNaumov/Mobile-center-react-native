...
- (void)fitness_getDailyActiveEnergyBurnedSamples:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback
{
    ...
    [self fetchCumulativeSumStatisticsCollection:activeEnergyBurned
                                            unit:unit
                                       startDate:startDate
                                         endDate:endDate
                                       ascending:ascending
...
- (void)fitness_getDailyAppleExerciseTimeSamples:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback
{
    ...
    HKQuantityType *appleExerciseTime = [HKObjectType quantityTypeForIdentifier:HKQuantityTypeIdentifierAppleExerciseTime];

    [self fetchCumulativeSumStatisticsCollection:appleExerciseTime
                                            unit:unit
                                       startDate:startDate
                                         endDate:endDate
                                       ascending:ascending
...
- (void)fitness_getDailyDistanceWalkingRunningSamples:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback
{
    ...
    [self fetchCumulativeSumStatisticsCollection:distanceWalkingRunning
                                            unit:unit
                                       startDate:startDate
                                         endDate:endDate
                                       ascending:ascending
